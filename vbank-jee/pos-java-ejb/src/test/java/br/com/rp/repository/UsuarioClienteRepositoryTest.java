...
/*	@Test
	...
	public void deveAlterarUsuarioClienteComSucesso() {
		...
		usuarioCliente.setNome("Marta");
		usuarioClienteRepository.save(usuarioCliente);
		Assert.assertEquals("Marta", usuarioClienteRepository.findById(100002L).getNome());
	}

	@Test
	@UsingDataSet("db/usuario_cliente.xml")
	public void deveCompararNomeUsuarioCliente() {
		Assert.assertEquals("Marta", usuarioClienteRepository.findById(100001L).getNome());
	}
