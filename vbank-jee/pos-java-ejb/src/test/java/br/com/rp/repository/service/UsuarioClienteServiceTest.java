...
public class UsuarioClienteServiceTest extends AbstractTest {
	...
	public void deveInserirUsuarioClienteComSucesso() {
		...
		cliente.setEmail("formiga@gmail.com");
		clienteService.save(cliente);

		UsuarioCliente usuarioCliente = new UsuarioCliente();
		usuarioCliente.setNome("Marta");
		usuarioCliente.setLogin("marta");
	...
	public void deveAlterarUsuarioClienteComSucesso() {
		...
		usuarioCliente.setNome("Marta");
		usuarioClienteService.save(usuarioCliente);
		Assert.assertEquals("Marta", usuarioClienteService.findById(100002L).getNome());
	}

	@Test
	@UsingDataSet("db/usuario_cliente.xml")
	public void deveCompararNomeUsuarioCliente() {
		Assert.assertEquals("Marta", usuarioClienteService.findById(100001L).getNome());
	}
