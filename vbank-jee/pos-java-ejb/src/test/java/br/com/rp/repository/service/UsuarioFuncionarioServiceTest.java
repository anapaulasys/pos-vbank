...
public class UsuarioFuncionarioServiceTest extends AbstractTest {
	...
	public void deveCompararNomeUsuarioFuncionario() {
		Assert.assertEquals("formiga", usuarioFuncionarioService.findById(100001L).getNome());
	}

	@Test
	@UsingDataSet("db/usuario_funcionario.xml")
	public void deveCompararLoginUsuarioFuncionario() {
		Assert.assertNotEquals("formiga", usuarioFuncionarioService.findById(100001L).getLogin());
	}
	...
	public void deveCompararNomeFuncionarioDoUsuario() {
		Assert.assertEquals("formiga", usuarioFuncionarioService.findById(100002L).getFuncionario().getNome());
	}
