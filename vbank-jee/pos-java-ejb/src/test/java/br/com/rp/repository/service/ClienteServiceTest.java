...
public class ClienteServiceTest extends AbstractTest {
	...
	public void deveInserirClienteComSucesso() {
		Assert.assertNotNull(clienteService.save(new Cliente("formiga", "157898775856","formiga@gmail.com", new BigDecimal(8550.00),
	...
	public void deveCompararNomeCliente() {
		Assert.assertEquals("Barbara", clienteService.findById(100002L).getNome());
	}
	...
	public void deveCompararEmailCliente(){
		Assert.assertEquals("monica@gmail.com", clienteService.findById(100001L).getEmail());
	}
}
