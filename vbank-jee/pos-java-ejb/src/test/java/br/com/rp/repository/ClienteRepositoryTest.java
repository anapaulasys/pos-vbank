...
/*
	...
	public void deveInserirClienteComSucesso() {
		Assert.assertNotNull(clienteRepository.save(new Cliente("formiga", "157898775856", "formiga@gmail.com", new BigDecimal(8550.00),
	...
	public void deveCompararNomeCliente() {
		Assert.assertEquals("Barbara", clienteRepository.findById(100002L).getNome());
	}
