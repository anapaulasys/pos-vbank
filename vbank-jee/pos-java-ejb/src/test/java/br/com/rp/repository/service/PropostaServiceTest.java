...
public class PropostaServiceTest extends AbstractTest {
	...
	public void deveCompararNomeFuncionarioAnalise() {
		Assert.assertEquals("formiga", usuarioFuncionarioService.findById(100001L).getFuncionario().getNome());
	}
	...
	public void deveRejeitarPropostaComSucesso() {
		...
		Assert.assertEquals("unicesumarjava@gmail.com", prop.getEmail());
		Assert.assertEquals("vbankemail@gmail.com", usuarioFuncionario.getFuncionario().getEmail());
